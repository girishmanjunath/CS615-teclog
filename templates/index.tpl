...
<div id="container">
    ...
    <div id="notepad">
        <div id="notepad-header" class="header">
            ...
            <span class="right">linker </span><span class="right" ><a href="https://ie.yahoo.com/?p=us"  target="_Blank"> <img src="images/yahoo.png"></a></span>
			<span class="right" ><a href="https://plus.google.com/"  target="_Blank"> <img src="images/google.jpeg"></a></span>
        </div>
        <div>
            {foreach from=$notes item=note}
